...
<script>
	...
	$(function() """),format.raw/*304.15*/("""{"""),format.raw/*304.16*/("""
		...
		setInterval(function() """),format.raw/*407.26*/("""{"""),format.raw/*407.27*/("""

			// Speed
			var chart = $('#container-speed').highcharts();
			if (chart) """),format.raw/*411.15*/("""{"""),format.raw/*411.16*/("""
				var point = chart.series[0].points[0];
				//   inc = Math.round((Math.random() - 0.5) * 100);

				// newVal = point.y + inc;
				/*  if (newVal < 0 || newVal > 100) """),format.raw/*416.41*/("""{"""),format.raw/*416.42*/("""
				      newVal = point.y - inc;
		...
		"""),format.raw/*423.3*/("""}"""),format.raw/*423.4*/(""", 2000);
...
<body>
	<div id="container">
		<div class="page-header" style="padding-bottom: 0px; margin-top: 5px;">
			<a href="/home"><img src=""""),_display_(Seq[Any](/*432.31*/routes/*432.37*/.Assets.at("images/logonew.png"))),format.raw/*432.69*/("""" height="70px"
		...
		<div id="lecture-number">LectureID: """),_display_(Seq[Any](/*447.40*/lectureNumber)),format.raw/*447.53*/("""</div>
		<table>
			<thead>
				<tr>
