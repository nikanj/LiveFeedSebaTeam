...
<body>
	...
	<div>
		<form method="get" action="/validate" class="form-horizontal" role="form">
			...
			"""),_display_(Seq[Any](/*116.5*/if(flag == 0 )/*116.19*/{_display_(Seq[Any](format.raw/*116.20*/("""
